...
- 🎯 Entry points to execute your program using `python -m <l1_rochacbruno_quart_template>` or `$ l1_rochacbruno_quart_template` with basic CLI argument parsing.
...
---
# l1_rochacbruno_quart_template Flask Application

Awesome l1_rochacbruno_quart_template created by hnsfnet
...
```bash
git clone https://github.com/hnsfnet/l1-rochacbruno-quart-template l1_rochacbruno_quart_template
cd l1_rochacbruno_quart_template
make install
```
...
```bash
pip install l1_rochacbruno_quart_template
```
...
```bash
$ l1_rochacbruno_quart_template
```

or

```bash
$ python -m l1_rochacbruno_quart_template
```
...
```bash
l1_rochacbruno_quart_template create-db   # run once
l1_rochacbruno_quart_template populate-db  # run once (optional)
l1_rochacbruno_quart_template add-user -u admin -p 1234  # ads a user
l1_rochacbruno_quart_template run
```

...
original_author="hnsfnet"
original_name="l1_rochacbruno_quart_template"
original_urlname="l1-rochacbruno-quart-template"
original_description="Awesome l1_rochacbruno_quart_template created by hnsfnet" 
...
rm -rf "${name}"
rm -rf tests
cp -R ${TEMPLATE_DIR}/l1_rochacbruno_quart_template "${name}"
...
then
    ...
    echo "then run 'l1_rochacbruno_quart_template' or 'python -m l1_rochacbruno_quart_template'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'l1_rochacbruno_quart_template' or 'python -m l1_rochacbruno_quart_template' or 'poetry run l1_rochacbruno_quart_template'"
fi

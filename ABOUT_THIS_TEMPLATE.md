...
├── l1_rochacbruno_quart_template             # The main python package for the project
...
e.g: `cat l1_rochacbruno_quart_template/VERSION` will get the project version without harming
